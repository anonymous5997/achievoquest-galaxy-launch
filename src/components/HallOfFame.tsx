...
import { Trophy, Medal, Award, Star } from "lucide-react";
 ...
 const HallOfFame = () => {
  ...
  //       >
  //         {[
  //           { label: "Gold Medals", value: "10", icon: Trophy },
  //           { label: "Silver Medals", value: "21", icon: Medal },
  //           { label: "Bronze Medals", value: "38", icon: Award },
  //           { label: "Top Rankings", value: "500+", icon: Star }
  //         ].map((stat, index) => (
  //           <motion.div
  //             key={stat.label}
